const CONNECTION_URL = "mongodb+srv://admin:leung123@cluster0-gh1xm.azure.mongodb.net/test?retryWrites=true"
...
Mongodb.connect(CONNECTION_URL, { useNewUrlParser: true }, (error, client) => {
    ...
    collection = database.collection("music")
...
exports.all = function(req, res) {
    console.log("Someone get all music data from the database")
